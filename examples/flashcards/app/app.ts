...
type SaveAnswers = Component<SaveAnswersProps, SaveAnswersState>;

function SaveAnswers() {
  return new Component<SaveAnswersProps, SaveAnswersState>({
    name: "SaveAnswers",
    ...
    onInserted(component: SaveAnswers) {
      const d = new Date;
...
type FlashCards = Component<FlashCardsProps, FlashCardsState>;

export function FlashCards(): FlashCards {
  return new Component<FlashCardsProps, FlashCardsState>({
    name: "FlashCards",
    ...
    onInserted(component: FlashCards) {
